...
def main():
    ...
    saved_at_label = tk.Label(notes_toolbar, textvariable=saved_at_var, anchor="e", fg="#0a7")
    saved_at_label.pack(side=tk.RIGHT)
    ...
    def tree_rename_pair():
        ...
        old_md_path = os.path.join(folder, base_old + ".md")
